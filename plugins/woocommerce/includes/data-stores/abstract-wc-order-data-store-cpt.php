...
abstract class Abstract_WC_Order_Data_Store_CPT extends WC_Data_Store_WP implements WC_Abstract_Order_Data_Store_Interface, WC_Object_Data_Store_Interface {
	...
	*/
	 ...
	 * for WordPress to function properly. We can therefore prime the post cache directly without compromising store isolation.
	 *
	 * @since 10.8.0
	 *
	 * @param array<int, object>            $line_items_all           Line item entries.
